...
ActiveRecord::Schema.define(version: 20160122103022) do
  ...
  add_index "asteroids_planets", ["asteroid_id", "planet_id"], name: "index_asteroids_planets_on_asteroid_id_and_planet_id", using: :btree
  add_index "asteroids_planets", ["planet_id", "asteroid_id"], name: "index_asteroids_planets_on_planet_id_and_asteroid_id", using: :btree
